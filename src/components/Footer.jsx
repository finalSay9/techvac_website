    ...
    <footer id="contact" className="bg-gray-900 text-white py-12 px-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 leading-relaxed">
              ...
              We transform ideas into reality with cutting-edge software development, 
              AI solutions, and stunning design.
            </p>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-teal-400">Contact</h4>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} TechVac. All rights reserved. | Built with React, Vite & Tailwind CSS</p>
        </div>
